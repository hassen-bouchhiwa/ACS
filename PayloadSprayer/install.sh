...
# Install Dalfox using snap and enable it
echo "Installing Dalfox using snap..."
sudo snap install dalfox
sudo systemctl enable --now snapd
sudo snap enable dalfox

# Import tplmap from GitHub and place it in the current directory
...
# Install Commix using apt, fall back to pip if apt fails
